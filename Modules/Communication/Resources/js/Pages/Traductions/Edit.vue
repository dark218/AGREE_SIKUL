...
function submitForm() {
    ...
    router.put(route('traductions.update', form.value.id), form.value, {
        onSuccess: () => {
...
<template>
    <Head :title="t('modules.communication.traductions.edit') || 'Modifier une traduction'" />

    <div class="body-wrapper">
        <div class="dashboard-header-wrapper">
            <h4 class="title">{{ t('modules.communication.traductions.edit') || 'Modifier une traduction' }}</h4>
        ...
        <div v-if="showCollapse" class="dash-payment-item-wrapper">
            ...
            <div class="form-actions mt-4">
                ...
                >
                    <i class="fa fa-save"></i> {{ t('actions.edit') || 'Modifier' }}
                </button>
            </div>
        </div>
