...
function performDelete() {
    ...
    router.put(route('modele-rapport.statut', props.item.id), {}, {
        onSuccess: () => {
...
<template>
    ...
    <div class="body-wrapper">
        <div class="dashboard-header-wrapper">
            ...
            <div class="actions">
                <Link v-if="can('modele-rapport-edit')" :href="route('modele-rapport.edit', item.id)" class="btn btn-warning">
                    {{ t('common.edit') }}
                </Link>
                <button v-if="can('modele-rapport-delete')" @click="confirmDelete" class="btn btn-danger">
                    {{ t('common.delete') }}
                </button>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <ModeleRapportForm :read-only="true" :modelerapport="item" />
            </div>
        </div>
        <ConfirmModal
