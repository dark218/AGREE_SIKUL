 ...
 *     title="Client",
 *     description="Resource pour l'entité Client",
...
class ClientResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'moyens_paiement' => $this->when($this->moyensPaiement, function() {
                return $this->moyensPaiement->map(function($moyen) {
                    return [
                        'id' => $moyen->id,
                        'type' => $moyen->type,
                        'type_label' => $moyen->getTypeLabel(),
                        'label' => $moyen->label,
                        'identifiant_masque' => $moyen->identifiant_masque,
                        'is_defaut' => $moyen->is_defaut,
                        'statut' => $moyen->statut,
                    ];
                });
            }),
