...
<template>
    <div class="row g-3 custom-input">
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                <label>{{ t('common.week_end_date') }}</label>
                <input
                    ...
                    :disabled="true"
                />
                <small class="text-muted d-block mt-1">{{ form.week_name }}</small>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td v-for="jour in jours" :key="`entree-${jour}`">
                                <input
                                    v-model="form.menus[jour][0].entree"
                                    type="text"
                        ...
                        <tr>
                            ...
                            <td v-for="jour in jours" :key="`plat-${jour}`">
                                <input
                                    v-model="form.menus[jour][0].plat"
                                    type="text"
                                    class="form-control form-control-sm"
                                    :disabled="isReadOnly"
                                    style="border: 1px solid #ccc; padding: 6px;"
                        ...
                        <tr>
                            ...
                            <td v-for="jour in jours" :key="`dessert-${jour}`">
                                <input
                                    v-model="form.menus[jour][0].dessert"
                                    type="text"
                                    class="form-control form-control-sm"
                                    :disabled="isReadOnly"
                                    style="border: 1px solid #ccc; padding: 6px;"
                        ...
                        <tr>
                            ...
                            <td v-for="jour in jours" :key="`remarques-${jour}`">
                                <input
                                    v-model="form.menus[jour][0].remarques"
                                    type="text"
                                    class="form-control form-control-sm"
                                    :disabled="isReadOnly"
                                    style="border: 1px solid #ccc; padding: 6px;"
