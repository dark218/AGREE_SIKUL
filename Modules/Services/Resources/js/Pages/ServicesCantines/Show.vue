...
function performDelete() {
    ...
    router.put(route('service-cantine.statut', props.item.id), {}, {
        onSuccess: () => {
...
<template>
    ...
    <div class="body-wrapper">
        <div class="dashboard-header-wrapper">
            ...
            <div class="actions">
                <Link v-if="can('service-cantine-edit')" :href="route('service-cantine.edit', item.id)" class="btn btn-warning">
                    {{ t('common.edit') }}
                </Link>
                <button v-if="can('service-cantine-delete')" @click="confirmDelete" class="btn btn-danger">
                    {{ t('common.delete') }}
                </button>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <ServiceCantineForm
                    :form="item"
                    :mode="'show'"
                    :anneesScolaires="anneeScolaires"
                    :niveaux="niveaux"
                    :cycles="cycles"
                    :ecoles="ecoles"
                    :campuses="campuses"
