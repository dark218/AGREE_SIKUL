...
const form = useForm({
    user_id: props.personnel?.user_id || '',
    matricule: props.personnel?.matricule || '',
    poste: props.personnel?.poste || '',
    departement_id: props.personnel?.departement_id || '',
    date_embauche: props.personnel?.date_embauche || '',
    type_contrat: props.personnel?.type_contrat || '',
    statut: props.personnel?.statut || 'actif',
});
const submitForm = () => {
    showUpdateLoader();
    form.put(route('personnels_administratifs.update', props.personnel.id), {
        onSuccess: () => {
            setTimeout(() => {
                hideLoader();
            }, 500);
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            <Link :href="route('personnels_administratifs.index')" class="btn btn-danger">
