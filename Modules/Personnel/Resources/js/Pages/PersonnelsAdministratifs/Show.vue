...
const deleteItem = () => {
    showDeleteLoader();
    router.visit(route('personnels_administratifs.destroy', props.personnel.id), {
        method: 'delete',
        preserveScroll: true,
        onSuccess: () => {
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="text-end">
                                        ...
                                        <Link :href="route('personnels_administratifs.edit', personnel.id)" class="btn btn-primary">
