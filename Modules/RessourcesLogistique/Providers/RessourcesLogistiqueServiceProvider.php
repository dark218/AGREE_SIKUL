...
namespace Modules\RessourcesLogistique\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class RessourcesLogistiqueServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'RessourcesLogistique';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'ressources-logistique';
    ...
    {
        $paths = [];
        $modulesPath = \Config::get('modules.paths.modules_path');
        if ($modulesPath) {
