...
class EnseignantController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Academique::Enseignants/Create', [
            ...
            'users' => $users,
            'communes' => Commune::whereNull('deleted_at')->select('id', 'libelle')->get()->toArray(),
            'departements' => Departement::whereNull('deleted_at')->select('id', 'libelle')->get()->toArray(),
            'regions' => Region::whereNull('deleted_at')->select('id', 'libelle')->get()->toArray(),
