...
const isSubmitDisabled = () => {
    return form.processing || (formComponent.value?.alreadyExists || false);
};
...
const submitForm = () => {
    showStoreLoader();
    form.post(route('academique.moyennes_matieres.store'), {
        onSuccess: () => {
            setTimeout(() => {
                hideLoader();
            }, 500);
                                    ...
                                    <div class="col">
                                        <div class="text-end">
                                            ...
                                            <button
                                                ...
                                                :title="(formComponent?.alreadyExists) ? 'Cette moyenne existe déjà!' : ''"
                                            >
