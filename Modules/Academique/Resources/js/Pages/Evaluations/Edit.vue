...
const form = useForm({
    code: props.evaluation?.code || '',
    titre: props.evaluation?.titre || '',
    type: props.evaluation?.type || '',
    classe_id: props.evaluation?.classe_id || null,
    matiere_id: props.evaluation?.matiere_id || null,
    date: props.evaluation?.date || '',
    coefficient: props.evaluation?.coefficient || '',
    sur: props.evaluation?.sur || '',
    statut: props.evaluation?.statut || 'actif',
});
const submitForm = () => {
    showUpdateLoader();
    form.put(route('academique.evaluations.update', props.evaluation.id), {
        onError: (errors) => {
