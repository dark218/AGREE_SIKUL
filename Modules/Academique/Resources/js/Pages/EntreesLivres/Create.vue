...
const submit = () => {
    showStoreLoader();
    form.post(route('academique.entrees-livres.store'), { onFinish: () => hideLoader() });
};
</script>
                ...
                <div class="dash-payment-item-wrapper">
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex align-items-center">
                            <span class="dash-payment-badge"><i class="fa fa-arrow-down"></i></span>
                            <h5 class="title mb-0">{{ t('actions.create') || 'Créer' }} — {{ t('fields.book_entry') || "Entrée de livre" }}</h5>
                        </div>
                        <div class="dash-payment-body">
                            <AlertMessage />
                            <form @submit.prevent="submit">
                                <EntreeLivreForm :form="form" :livres="livres" :structures="structures" mode="create" />
