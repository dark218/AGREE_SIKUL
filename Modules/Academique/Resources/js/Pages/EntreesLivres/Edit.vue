...
const submit = () => {
    showUpdateLoader();
    form.put(route('academique.entrees-livres.update', props.entree.id), { onFinish: () => hideLoader() });
};
</script>
                ...
                <div class="dash-payment-item-wrapper">
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex align-items-center">
                            ...
                            <h5 class="title mb-0">{{ t('actions.edit') || 'Modifier' }} — {{ t('fields.book_entry') || "Entrée de livre" }}</h5>
                        </div>
                        <div class="dash-payment-body">
                            <AlertMessage />
                            <form @submit.prevent="submit">
                                <EntreeLivreForm :form="form" :livres="livres" :structures="structures" mode="edit" />
