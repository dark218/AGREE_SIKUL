                ...
                <div class="dash-payment-item-wrapper">
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <div>
                                <ApprenantForm :form="form" :classes="classes" :sections="sections" :cycles="cycles" :ecoles="ecoles" :campuses="campuses" :communes="communes" :departements="departements" :regions="regions" :pays="pays" :quartiers="quartiers" :anneesScolaires="anneesScolaires" :typesApprenant="typesApprenant" :genres="genres" :statutsApprenants="statutsApprenants" :groupesSanguins="groupesSanguins" mode="edit" @submit="submitForm" />
                                <div class="row mt-3">
                                    <div class="col">
