...
const submitForm = () => {
    ...
    console.log('📋 Form data:', {
        seance_id: form.seance_id,
        apprenant_id: form.apprenant_id,
        date_presence: form.date_presence,
        heure_arrivee: form.heure_arrivee,
        heure_depart: form.heure_depart,
        statut: form.statut,
        remarques: form.remarques,
    });
    console.log('🎯 Route:', route('academique.presences_seances.store'));
    console.log('📊 Props seances:', props.seances);
    console.log('📊 Props apprenants:', props.apprenants);

    showStoreLoader();
    form.post(route('academique.presences_seances.store'), {
        onSuccess: () => {
