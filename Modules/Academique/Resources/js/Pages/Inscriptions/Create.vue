...
const form = useForm({
    ...
    frais_inscription: 0,
    frais_scolarite: 0,
    frais_dossier_paye: 0,
    frais_inscription_paye: 0,
    frais_scolarite_paye: 0,
    dossier_complet: false,
    fiche_inscription: null,
    carnet_vaccination: null,
    photos_4x4: null,
    copie_acte_naissance: null,
    piece1: null,
    piece2: null,
    piece3: null,
    piece4: null,
...
const submitForm = () => {
    showStoreLoader();
    form.post(route('academique.inscriptions.store'), {
        multipart: true,
        onSuccess: () => {
            setTimeout(() => {
                hideLoader();
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-start">
                                            <Link :href="route('academique.inscriptions.index')" class="btn btn-outline-secondary">
