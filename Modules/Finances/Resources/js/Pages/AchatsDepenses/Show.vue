                    ...
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex justify-content-between align-items-center" @click="toggleCollapse">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="title mb-0">{{ t('modules.finances.achats_depenses.show') || 'Voir un Achat / Dépense' }}</h5>
                            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            ...
                                            <Link :href="route('finances.achats-depenses.edit', item.id)" class="btn btn-primary">
