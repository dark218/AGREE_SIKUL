...
function submitForm() {
    showStoreLoader();
    form.post(route('administration.permissions.store'), {
...
<template>
    <Head :title="t('modules.administration.permissions.create')" />
                    ...
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex justify-content-between align-items-center" @click="toggleCollapse">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="title mb-0">{{ t('modules.administration.permissions.create') }}</h5>
                            </div>
                            ...
                            <form @submit.prevent="submitForm" class="form-row">
                                <div class="col-sm-12">
                                    ...
                                    <StylishSelect
                                        ...
                                        :placeholder="t('actions.select') + ' ' + t('modules.administration.features.title')"
                                    />
