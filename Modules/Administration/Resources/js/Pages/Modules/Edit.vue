...
const form = useForm({
    libelle: props.module.libelle || '',
    libelle_en: props.module.libelle_en || '',
    icone: props.module.icone || '',
    menu_url: props.module.menu_url || '',
    ordre: props.module.ordre || '',
});
// Collapse state
...
function submitForm() {
    showUpdateLoader();
    form.put(route('administration.modules.update', props.module.id), {
        onFinish: () => {
            hideLoader();
        }
    });
...
<template>
    <Head :title="t('modules.administration.modules.edit')" />
                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-title-area d-flex justify-content-between align-items-center" @click="toggleCollapse">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="title mb-0">{{ t('modules.administration.modules.edit') }}</h5>
                            </div>
