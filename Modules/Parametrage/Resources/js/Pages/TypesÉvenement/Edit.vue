...
import TypesÉvenementForm from './TypesÉvenementForm.vue';
...
const submitForm = () => {
    ...
    showUpdateLoader();
    form.put(route('parametrage.types_evenement.update', page.props.item?.id), {
        onError: (errors) => {
                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                <TypesÉvenementForm :form="form" mode="edit" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            <Link :href="route('parametrage.types_evenement.index')" class="btn btn-danger">
