...
import NaturesContratForm from './NaturesContratForm.vue';
...
const submitForm = () => {
    ...
    showUpdateLoader();
    form.put(route('parametrage.natures_contrat.update', page.props.item?.id), {
        onError: (errors) => {
                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                <NaturesContratForm :form="form" mode="edit" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            <Link :href="route('parametrage.natures_contrat.index')" class="btn btn-danger">
