...
const submitForm = () => {
    ...
    form.put(route('parametrage.quartiers.update', page.props.quartier?.id), {
        onSuccess: () => {
            hideLoader();
        },
        onError: (errors) => {
                    ...
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex justify-content-between align-items-center" @click="toggleCollapse">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="title mb-0">{{ t('modules.parametrage.quartiers.edit') || t('actions.edit') }}</h5>
                            </div>
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            <form @submit.prevent="submitForm">
                                <QuartiersForm :form="form" :communes="props.communes" :departements="props.departements" :regions="props.regions" :pays="props.pays" mode="edit" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            <Link :href="route('parametrage.quartiers.index')" class="btn btn-danger">
