...
const submitForm = () => {
    showUpdateLoader();
    form.put(route('parametrage.tuteurs.update', page.props.tuteur?.id), {
        onError: () => {},
        onFinish: () => { hideLoader(); }
    });
};
                    ...
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex justify-content-between align-items-center" @click="isCollapsed = !isCollapsed">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="title mb-0">{{ t('common.edit') }} - {{ page.props.tuteur?.nom }}</h5>
                            </div>
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                <TuteurForm :form="form" mode="edit" />
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
