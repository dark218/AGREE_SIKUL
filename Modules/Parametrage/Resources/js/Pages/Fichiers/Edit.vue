...
const page = usePage();
const form = useForm({
    code: page.props.fichier?.code || '',
    libelle: page.props.fichier?.libelle || '',
    libelle_en: page.props.fichier?.libelle_en || '',
});
const submit = () => {
    form.put(route('parametrage.fichiers.update', page.props.fichier?.id), {
        onError: (errors) => {
    ...
    <div class="body-wrapper">
        <div class="form-area">
            ...
            <form @submit.prevent="submit" class="custom-form">
                <FichiersForm :form="form" mode="edit" />
                <div class="mt-4">
