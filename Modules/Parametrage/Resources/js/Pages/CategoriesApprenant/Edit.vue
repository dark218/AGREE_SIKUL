...
const submitForm = () => {
    showStoreLoader();
    form.put(route('parametrage.categories_apprenant.update', props.item?.id), {
        onFinish: () => {
            hideLoader();
        },
        onError: () => {
                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                <CategorieApprenantForm :form="form" mode="edit" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            <Link :href="route('parametrage.categories_apprenant.index')" class="btn btn-danger">
