...
const search = () => {
    router.get(route('parametrage.categories_apprenant.index'), searchFilters.value, {
        preserveState: true,
        preserveScroll: true,
    });
};
const resetFilters = () => {
  ...
  router.get(route('parametrage.categories_apprenant.index'));
};
...
const deleteItem = () => {
    if (itemToDelete.value) {
        showDeleteLoader();
        router.visit(route('parametrage.categories_apprenant.destroy', itemToDelete.value?.id), { method: 'delete', preserveScroll: true,
            onSuccess: () => {
...
const toggleStatus = () => {
    if (itemToDelete.value) {
        ...
        router.visit(route('parametrage.categories_apprenant.statut', itemToDelete.value?.id), { method: 'put',
            preserveScroll: true,
            onSuccess: () => {
                showDeleteModal.value = false;
                itemToDelete.value = null;
        ...
        <div class="table-area">
            ...
            <div class="dashboard-header-wrapper">
                ...
                <div class="dashboard-btn-wrapper">
                    <div class="dashboard-btn" v-if="can('categories_apprenants-create')">
                        <Link :href="route('parametrage.categories_apprenant.create')" class="btn btn-primary">
                    ...
                    <div class="table-wrapper">
                        <div class="table-responsive">
                            <table class="custom-table">
                                ...
                                <tbody>
                                    <template v-if="props.categorieApprenants?.data && props.categorieApprenants?.data.length > 0">
                                        <tr v-for="categorie in props.categorieApprenants?.data" :key="categorie.id">
                                            ...
                                            <td class="fit">
                                                <div class="action-buttons">
                                                    <Link
                                                        :href="route('parametrage.categories_apprenant.show', categorie?.id)"
                                                    ...
                                                    <Link
                                                        v-if="can('categories_apprenants-edit')"
                                                        :href="route('parametrage.categories_apprenant.edit', categorie?.id)"
                        ...
                        <div class="mobile-card-list">
                            <template v-if="props.categorieApprenants?.data && props.categorieApprenants?.data.length > 0">
                                <div v-for="categorie in props.categorieApprenants?.data" :key="'m-' + categorie.id" class="mobile-card">
                                    ...
                                    <div class="mobile-card-actions">
                                        <Link :href="route('parametrage.categories_apprenant.show', categorie?.id)" class="btn btn-secondary"><span class="fa fa-eye"></span></Link>
                                        <Link v-if="can('categories_apprenants-edit')" :href="route('parametrage.categories_apprenant.edit', categorie?.id)" class="btn btn-primary"><span class="fa fa-edit"></span></Link>
                        ...
                        <!-- Pagination -->
                        <Pagination :data="props.categorieApprenants" />
                    </div>
                </div>
            </div>
        </div>
