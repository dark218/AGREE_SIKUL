...
const filterFields = [
    { key: 'libelle', type: 'text', placeholder: 'Libellé', icon: 'fa-search', width: '220px' },
    { key: 'statut', type: 'select', placeholder: 'Statut', options: statutOptions, optionValue: 'id', optionLabel: 'libelle', width: '190px' },
    { key: 'etat', type: 'select', placeholder: 'Etat', options: etatOptions, optionValue: 'id', optionLabel: 'libelle', width: '190px' },
];
