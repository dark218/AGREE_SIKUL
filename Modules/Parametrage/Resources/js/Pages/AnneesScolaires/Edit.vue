...
const form = useForm({
    code: page.props.annee_scolaire?.code || '',
    libelle: page.props.annee_scolaire?.libelle || '',
...
const submitForm = () => {
    showUpdateLoader();
    form.put(route('parametrage.annees_scolaires.update', page.props.annee_scolaire?.id), {
        onError: (errors) => {
                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                <AnneesScolairesForm :form="form" mode="edit" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            <Link :href="route('parametrage.annees_scolaires.index')" class="btn btn-danger">
