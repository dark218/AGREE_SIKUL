...
const submitForm = () => {
    ...
    form.post(route('parametrage.communes.store'), {
        onSuccess: () => {
            hideLoader();
        },
        onError: (errors) => {
                    ...
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex justify-content-between align-items-center" @click="toggleCollapse">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="title mb-0">{{ t('modules.parametrage.communes.create') || t('actions.create') }}</h5>
                            </div>
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            <form @submit.prevent="submitForm">
                                <CommunesForm :form="form" :departements="props.departements" :regions="props.regions" :pays="props.pays" mode="create" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
