...
const form = useForm({
    pays_devise_id: props.paysdevises?.[0]?.id || '',
    nom: '',
    code: '',
    type: '',
    statut: 'actif',
...
const logoPreview = ref('https://caer.univ-amu.fr/wp-content/uploads/default-placeholder.png');
...
const submitForm = () => {
    showStoreLoader();
    form.post(route('parametrage.fournisseurs_paiement.store'), {
        forceFormData: true,
        onFinish: () => {
            hideLoader();
        }
                    ...
                    <div class="dash-payment-item active">
                        <div class="dash-payment-title-area d-flex justify-content-between align-items-center" @click="toggleCollapse">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="title mb-0">{{ t('modules.parametrage.paymentProviders.create') }}</h5>
                            </div>
