...
// Alias pour compatibilité avec le v-model form.etat
const etatOptions = statusOptions;
</script>
<template>
        ...
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <input
                    ...
                    v-model="form.sigle"
                    class="form-control"
                    :placeholder="t('fields.sigle') || 'Sigle'"
                    :disabled="isReadOnly"
                />
                <span v-if="form.errors?.sigle" class="text-danger">
                    <strong>{{ form.errors.sigle }}</strong>
                </span>
            </div>
        </div>
        <!-- État -->
