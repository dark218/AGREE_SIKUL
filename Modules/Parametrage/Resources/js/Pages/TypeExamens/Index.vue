...
const search = () => {
    router.get(route('parametrage.types_examens.index'), searchFilters.value, {
        preserveState: true,
        preserveScroll: true,
    });
};
const resetFilters = () => {
  ...
  router.get(route('parametrage.types_examens.index'));
};
...
const deleteItem = () => {
    if (itemToDelete.value) {
        showDeleteLoader();
        router.visit(route('parametrage.types_examens.destroy', itemToDelete.value?.id), { method: 'delete', preserveScroll: true,
            onSuccess: () => {
...
const toggleStatus = () => {
    if (itemToDelete.value) {
        ...
        router.visit(route('parametrage.types_examens.statut', itemToDelete.value?.id), { method: 'put',
            preserveScroll: true,
            onSuccess: () => {
                showDeleteModal.value = false;
                itemToDelete.value = null;
        ...
        <div class="table-area">
            ...
            <div class="dashboard-header-wrapper">
                ...
                <div class="dashboard-btn-wrapper">
                    <div class="dashboard-btn" v-if="can('types-examens-create')">
                        <Link :href="route('parametrage.types_examens.create')" class="btn btn-primary">
            ...
            <div class="row m-0">
                ...
                <form @submit.prevent="search" style="display: flex; gap: 8px; align-items: flex-start; flex-wrap: wrap;">
                    ...
                    <div style="display: flex; gap: 4px;">
                        ...
                        <button @click="resetFilters" class="btn btn-secondary btn-sm" style="height: 32px; padding: 0 10px;">
                ...
                <div class="card-body">
                    <div class="table-wrapper">
                                        ...
                                        <tr v-for="item in types?.data" :key="item.id">
                                            ...
                                            <td class="fit">
                                                <div class="action-buttons">
                                                    <Link :href="route('parametrage.types_examens.show', item?.id)" class="btn btn-secondary"><span class="fa fa-eye"></span></Link>
                                                    <Link :href="route('parametrage.types_examens.edit', item?.id)" class="btn btn-primary"><span class="fa fa-edit"></span></Link>
                        ...
                        <div class="mobile-card-list">
                            <template v-if="types?.data && types?.data.length > 0">
                                <div v-for="item in types?.data" :key="'m-' + item.id" class="mobile-card">
