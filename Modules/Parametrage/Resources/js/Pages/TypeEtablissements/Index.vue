        ...
        <div class="table-area">
            ...
            <div class="dashboard-header-wrapper">
                ...
                <div class="dashboard-btn-wrapper">
                    <div class="dashboard-btn" v-if="can('types-etablissements-create')">
                                        ...
                                        <tr v-for="type in types?.data" :key="type.id">
                                            ...
                                            <td class="fit">
                                                <div class="action-buttons">
                                                    <Link :href="route('parametrage.types_etablissements.show', type?.id)" class="btn btn-secondary"><span class="fa fa-eye"></span></Link>
                                                    <Link :href="route('parametrage.types_etablissements.edit', type?.id)" class="btn btn-primary"><span class="fa fa-edit"></span></Link>
