...
const submitForm = () => {
    showUpdateLoader();
    form.put(route('parametrage.sections.update', page.props.section?.id), {
        onError: (errors) => {
                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                <SectionsForm :form="form" :ecoles="ecolesData" :niveaux="niveauxData" :anneesScolaires="page.props.anneesScolaires" mode="edit" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
                                            <Link :href="route('parametrage.sections.index')" class="btn btn-danger">
