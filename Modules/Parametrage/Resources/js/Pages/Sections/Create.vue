...
const submitForm = () => {
    showStoreLoader();
    form.post(route('parametrage.sections.store'), {
        onError: (errors) => {
                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body" :class="{ collapsed: isCollapsed }">
                            ...
                            <form @submit.prevent="submitForm">
                                <SectionsForm :form="form" :ecoles="ecolesData" :niveaux="niveauxData" :anneesScolaires="page.props.anneesScolaires" mode="create" />
                                <!-- Boutons -->
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="text-end">
