...
return new class extends Migration
{
    ...
    {
        // idempotence guard
        if (!Schema::hasTable('exam_finance_audit_logs')) Schema::hasTable('exam_finance_audit_logs') ? null : Schema::create('exam_finance_audit_logs', function (Blueprint $table) {
            $table->id();
