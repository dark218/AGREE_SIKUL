...
return new class extends Migration
{
    ...
    {
        // idempotence guard
        if (!Schema::hasTable('affectations_enseignants')) Schema::hasTable('affectations_enseignants') ? null : Schema::create('affectations_enseignants', function (Blueprint $table) {
            $table->id();
