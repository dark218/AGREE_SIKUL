...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('groupes_matieres', function (Blueprint $table) {
            ...
            $table->foreignId('matiere1_id')->nullable()->constrained('matieres_unites')->onDelete('set null');
            $table->foreignId('matiere2_id')->nullable()->constrained('matieres_unites')->onDelete('set null');
            $table->foreignId('matiere3_id')->nullable()->constrained('matieres_unites')->onDelete('set null');
