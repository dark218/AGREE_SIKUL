...
return new class extends Migration
{
    ...
    {
        // idempotence guard
        if (!Schema::hasTable('personnels_administratifs')) Schema::hasTable('personnels_administratifs') ? null : Schema::create('personnels_administratifs', function (Blueprint $table) {
            $table->id();
