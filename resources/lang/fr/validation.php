...
return [
    ...
    */
    ...
    'max' => [
        ...
        'file' => 'Le :attributene doit pas être plus grand que :max kilobytes.',
        'string' => 'Le :attribute ne doit pas être plus grand que :max caractères.',
        'array' => 'Le :attribute ne doit pas être plus grand que :max elements.',
    ],
    'mimes' => 'Le :attribute doit être un fichier de type: :values.',
    'mimetypes' => 'Le :attributedoit être un fichier de type: :values.',
    'min' => [
        'numeric' => 'Le :attribute ne doit pas être plus petit que :min.',
        'file' => 'Le :attribute ne doit pas être plus petit que :min kilobytes.',
        'string' => 'Le :attribute ne doit pas être plus petit que :min characters.',
        'array' => 'Le :attribute ne doit pas être plus petit que :min items.',
    ],
    ...
    'uuid' => 'Le :attribute doit être une UUID valide.',
